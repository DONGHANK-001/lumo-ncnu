...
const UPDATES: UpdateEntry[] = [
    {
        ...
        date: '2026-04-13',
        category: '優化',
        title: '⚡ SWR 快取 + 登入預載，切頁秒開',
        details: [
            '導入 SWR 快取層，個人檔案、排行榜、揪團列表、公開檔案四大頁面全面改用 SWR Hooks',
            '登入後背景預載徽章、統計、稱號、排行榜資料，切頁時瞬間顯示',
            '同一筆資料多處使用時自動去重，不重複發 API',
            '登出時自動清除快取，保護隱私',
            '揪團列表 Socket.io 即時更新無縫整合 SWR 快取',
        ],
    },
    {
        version: 'v1.19.1',
        date: '2026-04-13',
        category: '修復',
        title: '🛠️ 後端部署修復 & 稱號 / 徽章修正',
        details: [
            '修復後端 Render 部署持續失敗的問題（未使用的 import 導致 TypeScript 編譯錯誤）',
            '修正先鋒稱號在排行榜顯示為舊名稱（創始先鋒→破曉先驅等正確名稱）',
            '修正稱號標籤顯示 MUI Icon Key 字串（如「VerifiedUser 信譽見習生」→「信譽見習生」）',
            '修正公開檔案查看時徽章不會觸發解鎖檢查的問題',
            '前端所有稱號顯示加上 emoji 安全過濾，防止殘留符號',
            '公開檔案徽章卡片格式同步為與個人檔案一致的大小與間距',
        ],
    },
    {
        version: 'v1.19.0',
        date: '2026-04-13',
        category: '重大更新',
        title: '🎖️ 稱號系統全面升級為 MUI 圖標',
        details: [
            '全部 56+ 個稱號的 emoji 圖標替換為 MUI Material Icon',
            '個人檔案、公開檔案、排行榜、稱號對話框全面支援圖標渲染',
            '新增 TITLE_ICON_MAP 共用映射（29 種圖標），統一前端稱號圖標管理',
            '稱號選擇對話框改為圖標 + 文字排列，視覺更統一',
        ],
    },
    {
        version: 'v1.18.0',
